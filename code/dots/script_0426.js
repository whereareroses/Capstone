...
function locationUpdate(){
  ...
  if(params['trailPattern'] == 0){
    ...
    butterfly0.applyDestination(dot.mesh.position.x, dot.mesh.position.y, dot.mesh.position.z);
    butterfly0.move();
    butterfly0.update();
    butterfly1.applyDestination(dot2.mesh.position.x, dot2.mesh.position.y, dot2.mesh.position.z);
    butterfly1.move();
    butterfly1.update();
  }
  if(params['trailPattern'] == 1 && par){
